...
const (
	...
	TrainingOutcomeTimeout = "timeout"
...
func schedulerTrainingSample(task Task, labels TrainingLabels) *controlstate.SchedulerTrainingSample {
	...
	return &controlstate.SchedulerTrainingSample{
		...
		NeighborCount: feature.NeighborCount, LatencyP50Ms: feature.LatencyP50Ms,
		LatencyP90Ms: feature.LatencyP90Ms, LatencyStddevMs: feature.LatencyStddevMs,
		OutputTokensP70: feature.OutputTokensP70, SuccessRate: feature.SuccessRate,
		TimeoutRate: feature.TimeoutRate, CoverageLevel: feature.CoverageLevel,
		CoverageRatio:   feature.CoverageRatio,
